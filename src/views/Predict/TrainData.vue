    ...
    <el-card>
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="SMT_machine_name" :label="lang_dict.SMT_machine_name" width="160" sortable />
      ...
      <el-card class="card-form" shadow="never">
        <el-form ref="$form" :model="model" label-position="left" size="small">
          ...
          <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
            ...
            <el-col :span="6" :offset="0" :push="0" :pull="0" tag="div">
              <el-form-item :rules="rules.is_irr_spilt" prop="is_irr_spilt" :label="lang_dict.is_irr_spilt">
                <el-input v-model="model.is_irr_spilt" :placeholder="$t('Placeholder.Enter')" oninput="this.value=this.value.replace(/[^0-1]/g, '')" clearable />
              </el-form-item>
            </el-col>
            <el-col :span="6" :offset="0" :push="0" :pull="0" tag="div">
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, DeleteAllData, GetLangDict } from '@/api/Predict/TrainData'
