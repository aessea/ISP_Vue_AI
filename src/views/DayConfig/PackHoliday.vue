  ...
  <div id="main-box">
    <el-card>
      <el-row>
        <el-col :span="16">
          <div>
            <el-button v-if="buttons.includes('PackHoliday/add')" type="primary" @click="addDataDialog">
              <i class="el-icon-plus" />{{ $t('TablePage.BtnAppend') }}
            </el-button>
            <el-button v-if="buttons.includes('PackHoliday/delete')" type="danger" @click="deleteData">
              <i class="el-icon-delete" />{{ $t('TablePage.BtnDelete') }}
            </el-button>
            <el-button v-if="buttons.includes('PackHoliday/import')" @click="importDataDialog">
              <i class="el-icon-upload2" />{{ $t('TablePage.BtnImport') }}
            </el-button>
            <el-button v-if="buttons.includes('PackHoliday/export')" @click="exportDataDialog">
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="pack_line" :label="lang_dict.pack_line" sortable />
          <el-table-column prop="holiday_begin" :label="lang_dict.holiday_begin" sortable />
          <el-table-column prop="holiday_end" :label="lang_dict.holiday_end" sortable />
          <el-table-column width="110" fixed="right" :label="$t('TablePage.TitleOperate')">
            <template slot-scope="scope">
              <el-button
                v-if="buttons.includes('PackHoliday/modify')"
                type="primary"
                size="mini"
                icon="el-icon-edit"
                circle
              ...
              />
              <el-button
                v-if="buttons.includes('PackHoliday/delete')"
                type="danger"
                size="mini"
                icon="el-icon-delete"
                circle
      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.pack_line" prop="pack_line" :label="lang_dict.pack_line">
              <el-input v-model="model.pack_line" :placeholder="$t('Placeholder.Enter')" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.holiday_begin" prop="holiday_begin" :label="lang_dict.holiday_begin">
              <el-date-picker v-model="model.holiday_begin" :placeholder="$t('Placeholder.Select')" value-format="yyyy-MM-dd" :style="{width: '100%'}" />
            </el-form-item>
          </el-col>
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.holiday_end" prop="holiday_end" :label="lang_dict.holiday_end">
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, GetLangDict } from '@/api/DayConfig/PackHoliday'
export default {
  name: 'PackHoliday',
