    ...
    <el-card>
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="post_process" :label="lang_dict.post_process" sortable />
        ...
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          ...
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.process" prop="process" :label="lang_dict.process">
              <el-input v-model="model.process" :placeholder="$t('Placeholder.Select')" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.post_process" prop="post_process" :label="lang_dict.post_process">
              <el-input v-model="model.post_process" :placeholder="$t('Placeholder.Select')" clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, GetLangDict } from '@/api/DayConfig/AiMatchJobRule'
