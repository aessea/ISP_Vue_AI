  ...
  <div id="main-box">
    <el-card>
      <el-row>
        <el-col :span="16">
          <div>
            <el-button v-if="buttons.includes('AiMatchJobRule/add')" type="primary" @click="addDataDialog">
              <i class="el-icon-plus" />添加
            </el-button>
            <el-button v-if="buttons.includes('AiMatchJobRule/delete')" type="danger" @click="deleteData">
              <i class="el-icon-delete" />删除
            </el-button>
            <el-button v-if="buttons.includes('AiMatchJobRule/import')" @click="importDataDialog">
              <i class="el-icon-upload2" />导入
            </el-button>
            <el-button v-if="buttons.includes('AiMatchJobRule/export')" @click="exportDataDialog">
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="machine_name" label="组件规则" sortable />
          <el-table-column prop="process" label="制程" sortable />
          <el-table-column prop="post_process" label="后工序" sortable />
          <el-table-column width="110" fixed="right" label="操作">
            <template slot-scope="scope">
              <el-button
                v-if="buttons.includes('AiMatchJobRule/modify')"
                type="primary"
                size="mini"
                icon="el-icon-edit"
                circle
              ...
              />
              <el-button
                v-if="buttons.includes('AiMatchJobRule/delete')"
                type="danger"
                size="mini"
                icon="el-icon-delete"
                circle
      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.machine_name" prop="machine_name" label="组件规则">
          ...
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.post_process" prop="post_process" label="后工序">
              <el-input v-model="model.post_process" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    >
      ...
      <el-table
        ...
        border
      >
        <el-table-column prop="machine_name" label="组件规则" />
      </el-table> -->
      <el-row>
        <el-col :span="8">
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData } from '@/api/DayConfig/AiMatchJobRule'
