    ...
    <el-card>
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="go_where" :label="lang_dict.go_where" sortable />
      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.go_where" prop="go_where" :label="lang_dict.go_where">
              <el-input v-model="model.go_where" :placeholder="$t('Placeholder.Enter')" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.holiday_begin" prop="holiday_begin" :label="lang_dict.holiday_begin">
              <el-date-picker v-model="model.holiday_begin" type="datetime" :placeholder="$t('Placeholder.Select')" value-format="yyyy-MM-dd HH:00:00" :style="{width: '100%'}" />
            </el-form-item>
          </el-col>
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.holiday_end" prop="holiday_end" :label="lang_dict.holiday_end">
              <el-date-picker v-model="model.holiday_end" type="datetime" :placeholder="$t('Placeholder.Select')" value-format="yyyy-MM-dd HH:00:00" :style="{width: '100%'}" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, GetLangDict } from '@/api/DayConfig/DJHoliday'
export default {
  name: 'DJHoliday',
