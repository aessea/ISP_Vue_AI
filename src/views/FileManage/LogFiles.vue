  ...
  <div id="main-box">
    <el-card>
      <el-row>
        <el-col :span="16">
          <div>
            <el-button v-if="buttons.includes('LogFiles/delete')" type="danger" @click="deleteFiles">
              <i class="el-icon-delete" />删除文件
            </el-button>
            <el-button v-if="buttons.includes('LogFiles/deleteOld')" type="danger" @click="deleteBeforeFiles">
              <i class="el-icon-delete" />删除三个月前的文件
            </el-button>
            <el-button v-if="buttons.includes('LogFiles/reset')" type="primary" @click="resetAllFileList">
        ...
        >
          ...
          <el-table-column width="110" fixed="right" label="操作">
            <template slot-scope="scope">
              <el-button
                v-if="buttons.includes('LogFiles/download')"
                type="primary"
                size="mini"
