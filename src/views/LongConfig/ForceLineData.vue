      ...
      <el-row>
        <el-col :span="16">
          <div>
            ...
            <el-button v-if="buttons.includes('ForceLineData/delete')" type="danger" @click="deleteData">
              <i class="el-icon-delete" />{{ $t('TablePage.BtnDelete') }}
            </el-button>
            <el-button v-if="buttons.includes('ForceLineData/import')" @click="importDataDialog">
              <i class="el-icon-upload2" />{{ $t('TablePage.BtnImport') }}
            </el-button>
            <el-button v-if="buttons.includes('ForceLineData/export')" @click="exportDataDialog">
        ...
        >
          ...
          <el-table-column width="110" fixed="right" :label="$t('TablePage.TitleOperate')">
            <template slot-scope="scope">
              ...
              />
              <el-button
                v-if="buttons.includes('ForceLineData/delete')"
                type="danger"
                size="mini"
                icon="el-icon-delete"
                circle
      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.go_where_name" prop="go_where_name" :label="lang_dict.go_where_name">
              <el-input v-model="model.go_where_name" :placeholder="$t('Placeholder.Enter')" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.customer_name" prop="customer_name" :label="lang_dict.customer_name">
              <el-input v-model="model.customer_name" :placeholder="$t('Placeholder.Enter')" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.require_str_name" prop="require_str_name" :label="lang_dict.require_str_name">
              <el-input v-model="model.require_str_name" :placeholder="$t('Placeholder.Enter')" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
        ...
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.connecting_plates_num" prop="connecting_plates_num" :label="lang_dict.connecting_plates_num">
              <el-input v-model="model.connecting_plates_num" :placeholder="$t('Placeholder.Enter')" :style="{width: '100%'}" />
            </el-form-item>
          </el-col>
          <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.forced_line" prop="forced_line" :label="lang_dict.forced_line">
              <el-input v-model="model.forced_line" :placeholder="$t('Placeholder.Enter')" :rows="2" clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, GetLangDict } from '@/api/LongConfig/ForceLineData'
export default {
  name: 'ForceLineData',
