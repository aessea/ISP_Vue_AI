    ...
    <el-card>
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="line_name" label="需染色线体名" sortable />
          <el-table-column prop="points_threshold" label="染色点数阈值(单位：万点)" />
      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="12" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.line_name" prop="line_name" label="需染色线体名">
              <el-input v-model="model.line_name" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.points_threshold" prop="points_threshold" label="染色点数阈值(单位：万点)">
              <el-input v-model="model.points_threshold" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData } from '@/api/LongConfig/DyeLineData'
export default {
  name: 'DyeLineData',
