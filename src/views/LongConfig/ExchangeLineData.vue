  ...
  <div id="main-box">
    <el-card>
      <el-row>
        <el-col :span="16">
          <div>
            <el-button v-if="buttons.includes('ExchangeLineData/add')" type="primary" @click="addDataDialog">
              <i class="el-icon-plus" />{{ $t('TablePage.BtnAppend') }}
            </el-button>
            <el-button v-if="buttons.includes('ExchangeLineData/delete')" type="danger" @click="deleteData">
              <i class="el-icon-delete" />{{ $t('TablePage.BtnDelete') }}
            </el-button>
            <el-button v-if="buttons.includes('ExchangeLineData/import')" @click="importDataDialog">
              <i class="el-icon-upload2" />{{ $t('TablePage.BtnImport') }}
            </el-button>
            <el-button v-if="buttons.includes('ExchangeLineData/export')" @click="exportDataDialog">
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="exchange_line_one" :label="lang_dict.exchange_line_one" width="120" />
          <el-table-column prop="exchange_line_two" :label="lang_dict.exchange_line_two" width="120" />
          ...
          <el-table-column width="110" fixed="right" :label="$t('TablePage.TitleOperate')">
            <template slot-scope="scope">
              ...
              />
              <el-button
                v-if="buttons.includes('ExchangeLineData/delete')"
                type="danger"
                size="mini"
                icon="el-icon-delete"
                circle
    ...
    >
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          ...
          <el-col :span="6" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.exchange_line_one" prop="exchange_line_one" :label="lang_dict.exchange_line_one">
              <el-input v-model="model.exchange_line_one" :placeholder="$t('Placeholder.Enter')" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="6" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.exchange_line_two" prop="exchange_line_two" :label="lang_dict.exchange_line_two">
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, GetLangDict } from '@/api/LongConfig/ExchangeLineData'
  ...
  data() {
    return {
      ...
      model: {
        ...
        start_time: null,
        end_time: null,
        exchange_line_one: null,
        exchange_line_two: null,
        remark: null
      },
