  ...
  <div id="main-box">
    <el-card>
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="go_where_name" label="去向列名称" sortable />
        ...
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          ...
          <el-col :span="12" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.advance_days" prop="advance_days" label="提前天数">
              <el-input v-model="model.advance_days" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    >
      ...
      <el-table
        ...
        border
      >
        <el-table-column prop="go_where_name" label="去向列名称" />
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData } from '@/api/LongConfig/EarlyDueDateGoWhereName'
...
<style lang="scss" scoped>
  @import '../../assets/css/LongConfig/EarlyDueDateGoWhereName.scss';
</style>
<style>
.btnDanger{
