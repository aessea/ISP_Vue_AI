  ...
  <div id="main-box">
    <el-card>
      <el-row>
        <el-col :span="16">
          <div>
            <el-button v-if="buttons.includes('EarlyDueDateBoard8/add')" type="primary" @click="addDataDialog">
              <i class="el-icon-plus" />添加
            </el-button>
            <el-button v-if="buttons.includes('EarlyDueDateBoard8/delete')" type="danger" @click="deleteData">
              <i class="el-icon-delete" />删除
            </el-button>
            <el-button v-if="buttons.includes('EarlyDueDateBoard8/import')" @click="importDataDialog">
              <i class="el-icon-upload2" />导入
            </el-button>
            <el-button v-if="buttons.includes('EarlyDueDateBoard8/export')" @click="exportDataDialog">
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="component_name" label="机种名" sortable />
          ...
          <el-table-column width="110" fixed="right" label="操作">
            <template slot-scope="scope">
              ...
              />
              <el-button
                v-if="buttons.includes('EarlyDueDateBoard8/delete')"
                type="danger"
                size="mini"
                icon="el-icon-delete"
                circle
      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="12" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.component_name" prop="component_name" label="机种名">
              <el-input v-model="model.component_name" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12" :offset="0" :push="0" :pull="0" tag="div">
    ...
    >
      ...
      <el-table
        ...
        border
      >
        <el-table-column prop="component_name" label="机种名" />
        <el-table-column prop="advance_days" label="提前天数" />
      </el-table>
      <el-row>
        <el-col :span="8">
