  ...
  <div id="main-box">
    <el-card>
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="component_name" label="板号" sortable />
      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="12" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.component_name" prop="component_name" label="板号">
    ...
    >
      ...
      <el-table
        ...
        border
      >
        <el-table-column prop="component_name" label="板号" />
        <el-table-column prop="advance_days" label="提前天数" />
      </el-table>
      <el-row>
        <el-col :span="8">
