      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          ...
          <!-- <el-col :span="8" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.param_sources" prop="param_sources" label="数据来源(单位:时)">
              <el-input v-model="model.param_sources" placeholder="系统自动生成" disabled />
            </el-form-item>
          </el-col> -->
        </el-row>
      </el-form>
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, GetLangDict } from '@/api/LongConfig/BoardAdvanceDate'
