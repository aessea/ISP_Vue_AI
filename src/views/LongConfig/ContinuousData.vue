  ...
  <div id="main-box">
    <el-card>
      <el-row>
        <el-col :span="16">
          <div>
            <el-button v-if="buttons.includes('ContinuousData/add')" type="primary" @click="addDataDialog">
              <i class="el-icon-plus" />{{ $t('TablePage.BtnAppend') }}
            </el-button>
            <el-button v-if="buttons.includes('ContinuousData/delete')" type="danger" @click="deleteData">
              <i class="el-icon-delete" />{{ $t('TablePage.BtnDelete') }}
            </el-button>
            <el-button v-if="buttons.includes('ContinuousData/import')" @click="importDataDialog">
              <i class="el-icon-upload2" />{{ $t('TablePage.BtnImport') }}
            </el-button>
            <el-button v-if="buttons.includes('ContinuousData/export')" @click="exportDataDialog">
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="AI_continuous_name" :label="lang_dict.AI_continuous_name" />
          <el-table-column prop="DJ_continuous_name" :label="lang_dict.DJ_continuous_name" />

          <el-table-column width="110" fixed="right" :label="$t('TablePage.TitleOperate')">
            <template slot-scope="scope">
              <el-button
                v-if="buttons.includes('ContinuousData/modify')"
                type="primary"
                size="mini"
                icon="el-icon-edit"
                circle
              ...
              />
              <el-button
                v-if="buttons.includes('ContinuousData/delete')"
                type="danger"
                size="mini"
                icon="el-icon-delete"
                circle
      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="12" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.AI_continuous_name" prop="AI_continuous_name" :label="lang_dict.AI_continuous_name">
              <el-input v-model="model.AI_continuous_name" :placeholder="$t('Placeholder.Enter')" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="12" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.DJ_continuous_name" prop="DJ_continuous_name" :label="lang_dict.DJ_continuous_name">
              <el-input v-model="model.DJ_continuous_name" :placeholder="$t('Placeholder.Enter')" clearable />
            </el-form-item>
          </el-col>
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData, GetLangDict } from '@/api/LongConfig/ContinuousData'
export default {
  name: 'ContinuousData',
  ...
  data() {
    return {
      ...
      model: {
        id: null,
        AI_continuous_name: null,
        DJ_continuous_name: null
