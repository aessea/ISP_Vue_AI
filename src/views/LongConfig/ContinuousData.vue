    ...
    <el-card>
      ...
      <div class="table-box">
        ...
        >
          ...
          <el-table-column prop="AI_continuous_name" label="AI线体" />
          <el-table-column prop="DJ_continuous_name" label="点胶线体" />
      ...
      <el-form ref="$form" :model="model" label-position="left" size="small">
        <el-row :gutter="20" type="flex" justify="start" align="top" tag="div">
          <el-col :span="6" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.AI_continuous_name" prop="AI_continuous_name" label="AI线体">
              <el-input v-model="model.AI_continuous_name" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="6" :offset="0" :push="0" :pull="0" tag="div">
            <el-form-item :rules="rules.DJ_continuous_name" prop="DJ_continuous_name" label="点胶线体">
              <el-input v-model="model.DJ_continuous_name" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
...
import { GetTableData, AddData, ModifyData, DeleteData, HandleDelete, ExportData, ImportData } from '@/api/LongConfig/ContinuousData'
      ...
      tableDataExample: [
        {
          ...
          AI_continuous_name: '(必填)',
          DJ_continuous_name: '(必填)'
  ...
  methods: {
    ...
    handleDelete(index, row) {
      this.$confirm('确定要删除该数据？', '提示', {
        ...
        const data = {}
        data['id'] = row.id
        data['AI_continuous_name'] = row.AI_continuous_name
        data['DJ_continuous_name'] = row.DJ_continuous_name
        data['user_name'] = this.name
