export default {
  ...
  PublicText: {
    ...
    Yes: 'Yes', // 是
    No: 'No', // 否
    CompleteJob: 'Completed', // 完工
    NotCompleteJob: 'Not Completed', // 待产
    SelectOneKeyWord: 'Please enter at least one keyword', // 请至少输入一个关键词
    TextSearchSerial: 'Search Serial', // 搜索序列号
    TextSearchRemarkValue: 'Search Remark Value', // 搜索打件备注
    TextSearchSerialValue: 'Search Serial Value', // 搜索排程码
  ...
  route: { // 路由
    ...
    DJHoliday: 'DJHoliday', // 点胶放假表
    GetSmtMoDataResData: 'GetSmtMoDataResData', // AI参考SMT工单物料
    GetTryData: 'GetTryData', // 试跑工单表
    AiMatchJobRule: 'AiMatchJobRule', // AI匹配上阶工单规则表
    // 长期配置
    ...
    ContinuousData: 'One Comparison Data', // 一条龙对照表
    CorrespondenceData: 'AI-DJ Correspondence', // AI点胶对应关系表
    DispensingBeforeAIMachine: 'Dispensing Before AI', // 先点胶后AI特殊机种表
    EarlyDueDateGoWhereName: 'Early DueDate', // 去向列提前天数表
    DyeLineData: 'DyeLine Data', // 染色线体及阈值表
    ForceLineData: 'Force Line Data', // 强制线别表
    GroupAloneData: 'Group Alone Data', // 单独成组表
    // 预测数据
  ...
  SchedulePanelPage: {
    ...
    TextGetMainUploadTime: 'Get Main Upload File', // 获取AI上传文件
    TextGetSmallUploadTime: 'Get Small Upload File', // 获取点胶上传文件
    ...
    TextComputeTip6: 'The schedule file cannot be imported if the schedule file is not uploaded', // AI和点胶的排程文件未全部上传，无法导入
    ...
    BtnDownloadMain: 'Schedule File', // 下载AI排程
    BtnDownloadSmall: 'Schedule File', // 下载点胶排程
    ...
    BtnUploadMain: 'Upload File', // 上传AI排程
    BtnUploadSmall: 'Upload File', // 上传点胶排程
    BtnUploadABL: 'Upload File', // 上传ABL排程
    BtnImportFile: 'Import File', // 导入排程
    BtnTransferMain: 'Transfer Main', // AI转移扣点
    BtnTransferSmall: 'Transfer Small', // 点胶转移扣点
    BtnTransfer: 'Transfer Points', // 转移扣点
    BtnExportMain: 'Export File', // 导出AI
    BtnExportSmall: 'Export File', // 导出点胶
    BtnExportABL: 'Export File', // 导出ABL
    BtnGetMainUpload: 'Get Main Upload File', // 获取AI上传文件
    BtnGetSmallUpload: 'Get Small Upload File', // 获取点胶上传文件
  ...
  AnalysisControlPage: {
    ...
    BtnPsuhAINot: 'Push AI Unarranged', // 推送AI未排
    BtnPushAIPre: 'Push AI Prearranged', // 推送AI预排
    BtnPushAINor: 'Push AI Arranged', // 推送AI正排
  ...
  // 排程配置/排程配置管理
  ParamsConfigPage: {
    MainConfig: 'Config', // 排程配置
    SmallConfig: 'Small Config', // 点胶配置
  ...
  ProductionReportDataPage: {
    ...
    ConfirmSyncDatabase: 'Are you sure you want to synchronize the production reports of the database specified in the schedule configuration table？' // 确定要同步排程配置表中指定数据库的生产报表？
  },
  // 量产程序表
  ProductProgramDataPage: {
    UpdateMesData: 'Update Mes Data', // 更新MES程序
    ConfirmUpdateData1: 'Are you sure you want to update mass product program data?', // 确定要更新量产程序表？
    ConfirmUpdateData2: 'Note: This will erase all of the original data!' // 注意：此操作将会清空原来的所有数据！
  },
  // 运行日志
  HistoryRunPage: {
