export default {
  ...
  PublicText: {
    ...
    No: '否', // 否
    CompleteJob: '完工', // 完工
    NotCompleteJob: '待产', // 待产
    SelectOneKeyWord: '请至少输入一个关键词', // 请至少输入一个关键词
    TextSearchSerial: '搜索序列号', // 搜索序列号
    TextSearchRemarkValue: '搜索打件备注', // 搜索打件备注
    TextSearchSerialValue: '搜索排程码', // 搜索排程码
    TextSearchSMTMachine: '搜索SMT机种名' // 搜索SMT机种名
  },
  // 通用按钮
  PublicBtn: {
    Confirm: '确定', // 确定
  ...
  route: { // 路由
    ...
    DJHoliday: '点胶放假表', // 点胶放假表
    GetSmtMoDataResData: 'AI参考SMT工单物料', // AI参考SMT工单物料
    GetTryData: '试跑工单表', // 试跑工单表
    AiMatchJobRule: 'AI匹配上阶工单规则表', // AI匹配上阶工单规则表
    // 长期配置
    ...
    ProcessData: '制程配置表', // 制程配置表
    KeyBoardLineData: '按键板表', // 按键板表
    EarlyDueDateBoard8: '提早交期机种表', // 板号提早交期表
    ...
    ContinuousData: '一条龙对照表', // 一条龙对照表
    CorrespondenceData: 'AI点胶对应关系表', // AI点胶对应关系表
    DispensingBeforeAIMachine: '先点胶后AI特殊机种表', // 先点胶后AI特殊机种表
    EarlyDueDateGoWhereName: '去向列提前天数表', // 去向列提前天数表
    DyeLineData: '染色线体及阈值表', // 染色线体及阈值表
    ForceLineData: '强制线别表', // 强制线别表
    GroupAloneData: '单独成组表', // 单独成组表
    // 预测数据
    ...
    MainOutputFiles: 'AI输出文件', // AI输出文件
    SmallOutputFiles: '点胶输出文件', // 点胶输入文件
  ...
  SchedulePanelPage: {
    ...
    MainDowload: '下载AI', // 下载AI
    SmallDowload: '下载点胶', // 下载点胶
    LogDownload: '下载日志', // 下载日志
    Config: '配置', // 配置
    TitleDownloadNewMain: '下载最新AI排程', // 下载最新AI排程
    TitleDownloadNewSmall: '下载最新点胶排程', // 下载最新点胶排程
    TitleDownloadNewLog: '下载最新日志', // 下载最新日志
    TitleComputeBoth: '计算AI和点胶', // 计算AI和点胶排程
    TitleComputeMain: '计算AI', // 计算AI排程
    TitleComputeSmall: '计算点胶', // 计算点胶排程
    ComputeTextStep1: '上传排程文件', // 上传排程
    ComputeTextStep2: '导入排程文件', // 导入排程
    ComputeTextStep3: '更新排程信息', // 更新信息
    ComputeTextStep4: '计算排程', // 计算排程
    TextMainUploadName: '获取AI上传文件', // 获取AI上传文件
    TextSmallUploadName: '获取点胶上传文件', // 获取点胶上传文件
    TextChooseHoliday: '选择一个或多个包装放假日期', // 选择一个或多个包装放假日期
    TextUploadMainFile: '请上传AI排程文件', // 请上传AI排程文件
    TextUploadSmallFile: '请上传点胶排程文件', // 请上传点胶排程文件
    ...
    TextGetMainUploadTime: '获取AI上传文件', // 获取AI上传文件
    TextGetSmallUploadTime: '获取点胶上传文件', // 获取点胶上传文件
    ...
    TextComputeTip6: 'AI和点胶的排程文件未全部上传，无法导入', // AI和点胶的排程文件未全部上传，无法导入
    ...
    BtnComputeMain: '计算AI排程', // 计算AI排程
    BtnComputeSmall: '计算点胶排程', // 计算点胶排程
    BtnComputeBoth: '计算AI点胶', // 计算AI点胶
    BtnEndDeepSearch: '终止深度搜索', // 终止深度搜索
    BtnEndCompute: '终止计算排程', // 终止计算排程
    BtnPushStatistics: '推送量化结果', // 推送量化结果
    BtnDownloadMain: '下载AI排程', // 下载AI排程
    BtnDownloadSmall: '下载点胶排程', // 下载点胶排程
    ...
    BtnUploadMain: '上传AI排程', // 上传AI排程
    BtnUploadSmall: '上传点胶排程', // 上传点胶排程
    BtnUploadABL: '上传ABL排程', // 上传ABL排程
    BtnImportFile: '导入排程', // 导入排程
    BtnTransferMain: 'AI转移扣点', // AI转移扣点
    BtnTransferSmall: '点胶转移扣点', // 点胶转移扣点
    BtnTransfer: '转移扣点', // 转移
    BtnExportMain: '导出AI', // 导出AI
    BtnExportSmall: '导出点胶', // 导出点胶
    BtnExportABL: '导出ABL', // 导出ABL
    BtnGetMainUpload: '获取AI上传文件', // 获取AI上传文件
    BtnGetSmallUpload: '获取点胶上传文件', // 获取点胶上传文件
  ...
  AnalysisControlPage: {
    ...
    BtnPsuhAINot: '推送AI未排', // 推送AI未排
    BtnPushAIPre: '推送AI预排', // 推送AI预排
    BtnPushAINor: '推送AI正排', // 推送AI正排
  ...
  // 排程配置/排程配置管理
  ParamsConfigPage: {
    MainConfig: '排程配置', // 排程配置
    SmallConfig: '点胶配置', // 点胶配置
